    ...
    !function(e, t) {
      ...
      return function(e2) {
        ...
        return n.m = e2, n.c = t, n.d = function(e3, t2, r) {
          ...
          if (n.r(r), Object.defineProperty(r, "default", { enumerable: true, value: e3 }), 2 & t2 && "string" != typeof e3) for (var u in e3) n.d(r, u, (function(t3) {
            return e3[t3];
          }).bind(null, u));
          return r;
        }, n.n = function(e3) {
        ...
        function o(e3, t2) {
          ...
          var n2, r2, u2 = function(e4, t3) {
            ...
            for (r3 = 0; r3 < o3.length; r3++) n3 = o3[r3], t3.indexOf(n3) >= 0 || (u3[n3] = e4[n3]);
            return u3;
          }(e3, t2);
          if (Object.getOwnPropertySymbols) {
            var o2 = Object.getOwnPropertySymbols(e3);
            for (r2 = 0; r2 < o2.length; r2++) n2 = o2[r2], t2.indexOf(n2) >= 0 || Object.prototype.propertyIsEnumerable.call(e3, n2) && (u2[n2] = e3[n2]);
          }
          return u2;
        }
        n.r(t);
        ...
        var f = s, p = { width: 32, height: 32, textAlign: "center", marginRight: 20 }, d = c.a.memo(function(e3) {
          ...
          return { activeInput: l2, getOtpValue: f2, handleOnChange: function(e4) {
            ...
            e4.preventDefault();
            for (var n3 = f2(), r3 = e4.clipboardData.getData("text/plain").slice(0, o2 - l2).split(""), u3 = 0; u3 < o2; ++u3) u3 >= l2 && r3.length > 0 && (n3[u3] = r3.shift());
            for (var a2 = [n3.length], c3 = 0, i2 = 0; i2 < n3.length; ++i2) v2(n3[i2]) && (a2[c3] = n3[i2], c3++);
            p2(a2);
          ...
          var t2 = e3.OTPLength, n2 = e3.disabled, r2 = e3.autoFocus, o2 = e3.value, i2 = void 0 === o2 ? "" : o2, l2 = e3.onChange, s2 = e3.otpType, f2 = e3.secure, p2 = e3.className, v2 = e3.inputClassName, b2 = e3.inputStyles, m = e3.style, h = e3.placeholder, g = y({ autoFocus: r2, value: i2, otpType: s2, onChange: l2, OTPLength: t2 }), O = g.activeInput, j = g.getOtpValue, x = g.handleOnChange, T = g.handleOnKeyDown, w = g.handelOnInput, C = g.handleOnPaste, P = g.onInputFocus, S = Object(a.useMemo)(function() {
            for (var e4 = j(), u2 = [], o3 = 0; o3 < t2; o3++) u2.push(c.a.createElement(d, { className: v2, inputStyles: b2, key: o3, focus: O === o3, value: e4[o3], onChange: x, onKeyDown: T, onInput: w, onPaste: C, onInputFocus: P, index: o3, disabled: n2, autoFocus: r2, secure: f2, "data-testid": "input", otpType: s2, placeholder: h && h[o3] }));
            return u2;
